...
export class PaymentComponent {
  ...
  constructor(public pagamentoService: PagamentoService, private variableGlobal: VariableGlobal, private route: ActivatedRoute) {
  ...
  onSubmit(f){
      ...
      console.log(this.codSegCard, 'codSegCard')
        ...
        this.pagamentoService.startSession(this.id).toPromise().then((response:any) => {
    ...
    enviaDadosParaServidor(){
      ...
      this.pagamentoService.store(this.data, this.id).toPromise().then((response:any) => {
